...
PRODUCT_COPY_FILES += \
    device/moto/shadow/init.mapphone_cdma.rc:root/init.mapphone_cdma.rc \
    device/moto/shadow/ueventd.mapphone_cdma.rc:root/ueventd.mapphone_cdma.rc

## (2) Also get non-open-source CDMA-specific aspects if available
$(call inherit-product-if-exists, vendor/moto/shadow/shadow-vendor.mk)
...
PRODUCT_COPY_FILES += \
    device/moto/shadow/media_profiles.xml:system/etc/media_profiles.xml \
    device/moto/shadow/01_Vendor_ti_omx.cfg:system/etc/01_Vendor_ti_omx.cfg
...
PRODUCT_COPY_FILES += \
    device/moto/shadow/DroidXBootstrap.cfg:system/etc/DroidXBootstrap.cfg \
    device/moto/shadow/Droid2Bootstrap.cfg:system/etc/Droid2Bootstrap.cfg \
    device/moto/shadow/vold.fstab:system/etc/vold.fstab \
    device/moto/shadow/apns-conf.xml:system/etc/apns-conf.xml \
    device/moto/shadow/mount_ext3.sh:system/bin/mount_ext3.sh
