...
adb pull /system/etc/firmware/ap_bt_data.bin ../../../vendor/moto/$DEVICE/proprietary/etc/firmware
...
adb pull /system/lib/hw/lights.shadow.so ../../../vendor/moto/$DEVICE/proprietary/lib/hw
adb pull /system/lib/hw/sensors.shadow.so ../../../vendor/moto/$DEVICE/proprietary/lib/hw
adb pull /system/lib/hw/gps.shadow.so ../../../vendor/moto/$DEVICE/proprietary/lib/hw
...
adb pull /system/usr/keychars/cdma_shadow-keypad.kcm.bin ../../../vendor/moto/$DEVICE/proprietary/usr/keychars

adb pull /system/usr/keylayout/cdma_shadow-keypad.kl ../../../vendor/moto/$DEVICE/proprietary/usr/keylayout
...
PRODUCT_COPY_FILES += \\
    ...
    vendor/moto/__DEVICE__/proprietary/etc/firmware/ap_bt_data.bin:/system/etc/firmware/ap_bt_data.bin \\
    ...
    vendor/moto/__DEVICE__/proprietary/etc/wifi/fw_tiwlan_ap.bin:/system/etc/wifi/fw_tiwlan_ap.bin \\
    vendor/moto/__DEVICE__/proprietary/etc/wifi/fw_wlan1271.bin:/system/etc/wifi/fw_wlan1271.bin \\
    vendor/moto/__DEVICE__/proprietary/etc/wifi/hostapd.conf.templet:/system/etc/wifi/hostapd.conf.templet \\
    vendor/moto/__DEVICE__/proprietary/etc/wifi/tiwlan.ini:/system/etc/wifi/tiwlan.ini \\
    vendor/moto/__DEVICE__/proprietary/etc/wifi/tiwlan_ap.ini:/system/etc/wifi/tiwlan_ap.ini \\
    ...
    vendor/moto/__DEVICE__/proprietary/lib/libmotoims-sms.so:/system/lib/libmotoims-sms.so \\
    ...
    vendor/moto/__DEVICE__/proprietary/usr/keychars/cdma_shadow-keypad.kcm.bin:/system/usr/keychars/cdma_shadow-keypad.kcm.bin \\
    vendor/moto/__DEVICE__/proprietary/usr/keychars/cdma_shadow-keypad.kcm.bin:/system/usr/keychars/qwerty.kcm.bin \\
    vendor/moto/__DEVICE__/proprietary/usr/keychars/cdma_shadow-keypad.kcm.bin:/system/usr/keychars/qwerty2.kcm.bin \\
    vendor/moto/__DEVICE__/proprietary/usr/keylayout/cdma_shadow-keypad.kl:/system/usr/keylayout/cdma_shadow-keypad.kl \\
    vendor/moto/__DEVICE__/proprietary/usr/keylayout/cdma_shadow-keypad.kl:/system/usr/keylayout/qwerty.kl \\
    ...
    vendor/moto/__DEVICE__/proprietary/lib/hw/lights.shadow.so:/system/lib/hw/lights.shadow.so \\
    vendor/moto/__DEVICE__/proprietary/lib/hw/sensors.shadow.so:/system/lib/hw/sensors.shadow.so \\
    vendor/moto/__DEVICE__/proprietary/lib/hw/gps.shadow.so:/system/lib/hw/gps.shadow.so \\
